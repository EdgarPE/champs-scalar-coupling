...
def t2_preprocess_data(train, test, structures, contributions):
...
def t2_to_parquet(work_dir, train, test, sub, structures, contributions):
    train.to_parquet(f'{work_dir}/t2_train.parquet')
    test.to_parquet(f'{work_dir}/t2_test.parquet')
    sub.to_parquet(f'{work_dir}/t2_sub.parquet')
    structures.to_parquet(f'{work_dir}/t2_structures.parquet')
    contributions.to_parquet(f'{work_dir}/t2_contributions.parquet')


def t2_read_parquet(work_dir):
    train = pd.read_parquet(f'{work_dir}/t2_train.parquet')
    test = pd.read_parquet(f'{work_dir}/t2_test.parquet')
    sub = pd.read_parquet(f'{work_dir}/t2_sub.parquet')
    structures = pd.read_parquet(f'{work_dir}/t2_structures.parquet')
    contributions = pd.read_parquet(f'{work_dir}/t2_contributions.parquet')

    return train, test, sub, structures, contributions


def t2_prepare_columns(train, test):
