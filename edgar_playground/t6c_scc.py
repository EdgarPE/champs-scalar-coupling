...
train_csv = pd.read_csv(f'{INPUT_DIR}/train.csv', index_col='id', dtype=train_dtypes)
train_csv['molecule_index'] = train_csv.molecule_name.str.replace('dsgdb9nsd_', '').astype('int32')
train_csv = train_csv[['molecule_index', 'atom_index_0', 'atom_index_1', 'type', 'scalar_coupling_constant']]
print(train_csv.head(10))


submit = pd.read_csv(f'{INPUT_DIR}/sample_submission.csv')


test_csv = pd.read_csv(f'{INPUT_DIR}/test.csv', index_col='id', dtype=train_dtypes)
...
structures_csv = pd.read_csv(f'{INPUT_DIR}/structures.csv', dtype=structures_dtypes)
...
for mol_type in TYPE_WL:

    model_name_wrt = ('../work/keras-neural-net-and-distance-features-molecule_model_%s.hdf5' % mol_type)
    print('Training %s' % mol_type, 'out of', TYPE_WL, '\n')
