...
N_ESTIMATORS = {
    '_': 4000, # 8000-nek még van értelme
}
...
SEARCH_PARAMS = {
    '_': {
        ...
        'learning_rate': sp_uniform(loc=0.01, scale=0.4),
...
for type_name in TYPE_WL:
    for target in TARGET_WL:
        ...
        clf = lgb.LGBMRegressor(random_state=SEED, silent=True, metric='mae', n_jobs=-1, n_estimators=_N_ESTIMATORS,
                                max_depth=12, objective='regression', num_leaves=128, boosting_type='gbdt',
                                subsample_freq=1, bagging_seed=SEED, verbosity=-1,
                                min_child_samples=22) # colsample_bytree=1.0,  reg_alpha=0.1,  reg_lambda=0.3, subsample=1, learning_rate=0.1,
